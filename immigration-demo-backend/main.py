...
sio: socketio.AsyncServer = socketio.AsyncServer(async_mode="asgi", cors_allowed_origins=['http://localhost:4200', 'https://holthe-demo.fly.dev'])
...
# mount angular dist.
app.mount(
    "/", StaticFiles(directory="../immigration-demo-frontend/dist/immigration-demo-frontend", html=True), name="static"
)
...
async def startup_event():
    ...
    if not Path("vectorStore/holthelaw-blogs-markdown-vectorStore.pkl").exists():
